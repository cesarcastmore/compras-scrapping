...
public class WalMart {
	...
	public JSONObject search(String searchQuery, Integer pageNum) throws Exception {
		...
		String url = "https://www.walmart.com.mx/productos?Ntt=" +searchQuery;
		...
		try {
			...
			page.executeJavaScript("fetch(\"https://www.walmart.com.mx/api/page/search?Ntt=" + URLEncoder.encode(searchQuery, "UTF-8") + "&Nrpp=24&No=0\", {\"credentials\":\"omit\",\"headers\":{\"accept\":\"application/json\",\"content-type\":\"application/json\"},\"referrer\":\"https://www.walmart.com.mx/productos?Ntt=martillo\",\"referrerPolicy\":\"no-referrer-when-downgrade\",\"body\":null,\"method\":\"GET\",\"mode\":\"cors\"}).then(function(response) {\n" +
